...
const Login = () => {
  ...
  // Ottieni l'URL di redirect, se presente
  ...
  const handleSubmit = async (e) => {
    ...
    if (!email.trim()) {
      setError && setError('Inserisci la tua email');
      return;
    }
    
    if (!password) {
      setError && setError('Inserisci la password');
      return;
    }
    ...
    try {
      ...
      // La redirezione verrà gestita dall'effetto useEffect sopra
    } catch (err) {
      // Gli errori sono gestiti nel contesto Auth
    ...
    <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gray-50">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Gestisci il tuo business di dropshipping in un unico posto
        </p>
      </div>
